...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "agriculture_water_quality_daily_stats")
@ApiModel(value = "AgricultureWaterQualityDailyStats", description = "水质数据日统计表")
public class AgricultureWaterQualityDailyStats implements Serializable {
