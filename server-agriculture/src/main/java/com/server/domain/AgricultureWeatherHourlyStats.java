...
@NoArgsConstructor
@AllArgsConstructor
@TableName(value = "agriculture_weather_hourly_stats")
@ApiModel(value = "AgricultureWeatherHourlyStats", description = "气象数据小时统计表")
public class AgricultureWeatherHourlyStats implements Serializable {
